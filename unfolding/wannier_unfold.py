...
from unfolder.plot import plot_band_weight
import matplotlib.pyplot as plt
from unfolder.wannier.myTB import MyTB
...
if __name__=="__main__":
    run(path='/home/hexu/projects/unfolder/example/elec_unfolding/data',
        prefix='wannier90',
        scmat=[[1,-1,0], [1,1,0 ], [0,0,2]],
